...
export function FileUploader({
    ...
    const handleUpload = async (fileToUpload: File) => {
        ...
        try {
            ...
            const public_id = `${folder}/${fileToUpload.name}`;
    ...
    return (
        <div className="w-full">
            ...
            {mode !== "button" && (!file || !isUploading) && (
                <div
                    {...getRootProps()}
                    className={`flex h-48 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 transition-colors hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-800 ${isDragActive ? "border-blue-500 bg-blue-50" : ""
                        }`}
                >
                    <input {...getInputProps()} />
