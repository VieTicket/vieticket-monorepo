...
import { Calendar, Clock, MapPin, Armchair, Receipt, User } from "lucide-react"
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="absolute top-0 left-2/3 -translate-x-1/2 w-6 h-6 bg-gray-50 dark:bg-gray-900 rounded-b-full -mt-3 border-b border-gray-200 dark:border-gray-700"></div>
        <div className="absolute bottom-0 left-2/3 -translate-x-1/2 w-6 h-6 bg-gray-50 dark:bg-gray-900 rounded-t-full -mb-3 border-t border-gray-200 dark:border-gray-700"></div>

        {/* Dashed Divider Line */}
        <div className="absolute left-2/3 top-3 bottom-3 border-l-2 border-dashed border-gray-300 dark:border-gray-600"></div>
            ...
            <div className="space-y-3">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Special Guest Performance</p>
                </div>
                <Badge className={`${getStatusColor(ticket.status)} text-xs`}>{ticket.status.toUpperCase()}</Badge>
              </div>
          ...
          <div className="w-1/3 p-6 pl-8 flex flex-col items-center justify-center">
            <div className="flex flex-col items-center space-y-3">
              {isLoadingQr ? (
                ...
                <div className="w-24 h-24 flex items-center justify-center bg-gray-200 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600">
                  <p className="text-xs text-red-500 text-center px-2">QR Code Error</p>
                </div>
              )}
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center font-medium">Scan at entrance</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              Present these QR codes at the event entrance for entry. Click on any ticket to view full details.
            </p>
          </CardHeader>
          <CardContent>
