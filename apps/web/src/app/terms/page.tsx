        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8 text-center">
            <p className="text-lg text-gray-700 max-w-4xl mx-auto">
              Chào mừng bạn đến với VIETICKET. Khi truy cập website/ứng dụng và thực hiện giao dịch, 
          ...
          <Tabs defaultValue="general" className="space-y-6">
            <TabsList className="grid w-full grid-cols-3 max-w-2xl mx-auto">
              <TabsTrigger value="general" className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline">Điều khoản chung</span>
              ...
              <TabsTrigger value="organizers" className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline">Nhà tổ chức</span>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-gray-50 to-yellow-50 rounded-xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600 mb-6">
                Nếu bạn có thắc mắc về các điều khoản và điều kiện, hãy liên hệ với chúng tôi.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild>
                  <a href="mailto:support@vieticket.com">Gửi email</a>
                </Button>
              </div>
            </div>
          </div>
