...
import { useAdminStats, useChartData } from "@/lib/hooks/use-admin-data";
import { PageSkeleton, ChartSkeleton, StatsCardSkeleton } from "@/components/ui/loading";
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-red-500">
            Error loading dashboard: {statsError?.message || chartError?.message || 'An error occurred'}
          </p>
        </div>
      </div>
    );
