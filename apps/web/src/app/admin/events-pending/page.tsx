...
const EventCard = ({
  ...
  return (
    <Card
      className="h-full flex flex-col overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-200 bg-white border-gray-200 hover:border-violet-400/50"
      onClick={onClick}
    >
      <CardHeader className="pb-3 flex-shrink-0">
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <CardTitle className="text-lg font-semibold line-clamp-2 leading-tight text-gray-900">
              {event.title}
            </CardTitle>
      ...
      <CardContent className="flex-1 flex flex-col min-h-0">
        ...
        <div className="space-y-3 flex-1 min-h-0">
          <div 
            className="text-sm text-gray-700 line-clamp-3 leading-relaxed prose prose-sm max-w-none prose-invert"
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2 text-gray-700">
              <Calendar className="h-4 w-4 flex-shrink-0 text-yellow-500" />
            ...
            <div className="flex items-center gap-2 text-gray-700">
              <User className="h-4 w-4 flex-shrink-0 text-yellow-500" />
              <span className="truncate">
            ...
            <div className="flex items-center gap-2 text-gray-700">
              <Eye className="h-4 w-4 flex-shrink-0 text-yellow-500" />
              <span className="truncate">
        ...
        {event.approvalStatus !== "pending" ? (
          <div
            className="flex gap-2 mt-4 pt-4 border-t border-gray-200 flex-shrink-0"
          ...
          >
            {event.approvalStatus === "approved" && onEdit && (
              <Button
                ...
                variant="outline"
                size="sm"
                className="px-3 flex-shrink-0 border-gray-300 bg-white text-gray-900 hover:bg-violet-50 hover:border-violet-400 hover:text-violet-700"
                title="Edit"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-10 bg-white border-gray-300 text-gray-900 placeholder:text-gray-600 focus:border-violet-400"
                />
              </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-2">
                <div className="flex items-center gap-2 flex-shrink-0">
                  <CalendarDays className="h-4 w-4 text-yellow-500 flex-shrink-0" />
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 flex-1 min-w-0">
                  <Input
                    ...
                    className="w-full sm:w-auto sm:min-w-[140px] bg-white border-gray-300 text-gray-900 placeholder:text-gray-600 focus:border-violet-400"
                  />
                  <span className="text-sm text-gray-600 text-center sm:text-left sm:mx-1">to</span>
                  <Input
                    id="endDate"
                    type="date"
                    value={endDate}
                  ...
                  {(startDate || endDate) && (
                    <Button
                      ...
                      className="w-full sm:w-auto sm:ml-2 border-gray-300 bg-white text-gray-900 hover:bg-violet-50 hover:border-violet-400 hover:text-violet-700"
                    >
                      Reset
                    </Button>
                  )}
      ...
      {!filteredEvents || filteredEvents.length === 0 ? (
        <Card className="bg-white border-gray-200">
          <CardContent className="text-center py-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 px-4 break-words">
              {(() => {
                if (
                  searchQuery.trim() ||
                  selectedCategory !== "all" ||
