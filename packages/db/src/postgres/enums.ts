...
// Role type
export const ROLE_VALUES = ["customer", "organizer", "admin", "unassigned"] as const;
export type Role = typeof ROLE_VALUES[number];
export type UserAssignableRole = Exclude<Role, "admin" | "unassigned">;
export const roleEnum = pgEnum("role", ROLE_VALUES);

// Upload status type
export const UPLOAD_STATUS_VALUES = ["pending", "uploaded", "verified", "active", "destroyed"] as const;
...
// Order status type
export const ORDER_STATUS_VALUES = ["pending", "paid", "cancelled", "refunded"] as const;
